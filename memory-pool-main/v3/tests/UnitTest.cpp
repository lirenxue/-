...
void testBasicAllocation()
{
    ...
    std::cout << "基础分配测试成功!" << std::endl;
}

// 内存写入测试
void testMemoryWriting()
{
    std::cout << "内存写入测试..." << std::endl;
