...
public:
    ...
    static void testSmallAllocation()
    {
        ...
        std::cout << "\n小内存分配测试(" << NUM_ALLOCS << " 次 "
            << SMALL_SIZE << "字节):" << std::endl;
        ...
        // 测试内存池
        {
            ...
            std::cout << "优化后的MemoryPool: " << std::fixed << std::setprecision(3)
        ...
        // 测试new/delete
        {
            ...
            std::cout << "系统New/Delete: " << std::fixed << std::setprecision(3)
                << t.elapsed() << " ms" << std::endl;
        }
    }
    ...
    static void testMultiThreaded()
    {
        ...
        std::cout << "\n多线程测试 (" << NUM_THREADS
            << " 个线程,每个线程执行" << ALLOCS_PER_THREAD << "次):"
            << std::endl;
        ...
        // 测试内存池
        {
            ...
            std::cout << "优化后MemoryPool: " << std::fixed << std::setprecision(3)
                << t.elapsed() << " ms" << std::endl;
        }
